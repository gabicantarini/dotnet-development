...
class Program
{
    static void Main(string[] args)
    {
        ...
        switch (option)
        {
            case "1": Console.WriteLine("New plan information.");
                break;
            case "2": Console.WriteLine("Tell me about your complain."); 
                break;
            case "3": Console.WriteLine("Give me your email to send you a new invoice.");
                break;
            case "4": Console.WriteLine("See you next time.");
                break;
            default: Console.WriteLine("Use a valid option.");
                break;
        }
    }
}